        ...
        <div className="card" style={{ padding: '2.5rem 2rem' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ color: '#a0aec0', fontSize: '0.9rem' }}>
              {forgotMode ? 'Reset your password' : 'Predict. Compete. Win.'}
            </p>
          </div>
            ...
            forgotSuccess ? (
              <div>
                ...
                >
                  ...
                  <p style={{ color: '#2f855a', fontSize: '0.85rem', lineHeight: 1.5 }}>
                    Check your email at <strong>{forgotEmail}</strong> and click the reset link.
              ...
              <div>
                ...
                <p style={{ color: '#718096', fontSize: '0.85rem', marginBottom: '1.25rem', lineHeight: 1.5 }}>
